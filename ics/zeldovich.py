...
class Zeldovich:
    ...
    def __init__(self, class_config :str, boxsize :float, pixels :int, redshift :float, read_hdf5 :str, write_hdf5 :str, fnl :float, seed :int, out_units='kpch', scaling='trivial'):
        ...
        if self.out_units == 'mpch':
            self.factor = self.background.h
        elif self.out_units == 'kpch':
